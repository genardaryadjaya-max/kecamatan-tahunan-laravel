    ...
    <div class="container-fluid px-4 py-6">
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <h1 class="h3 mb-0 text-white font-bold">Tambah Layanan</h1>
            </div>
        </div>
            ...
            <div class="p-6 border-b border-white/5">
                <form action="{{ route('admin.layanan.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" class="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold transition-colors" value="{{ old('name') }}" required>
                        @error('name') <span class="text-red-400 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-white/80 mb-2">Ikon (FontAwesome Class)</label>
                        <input type="text" name="icon" class="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold transition-colors" value="{{ old('icon', 'fas fa-link') }}" placeholder="Contoh: fas fa-id-card">
                    ...
                    <div>
                        ...
                        <input type="url" name="url" class="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold transition-colors" value="{{ old('url') }}" placeholder="https://...">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="order" class="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold transition-colors" value="{{ old('order', 0) }}">
