    ...
    <div class="container-fluid px-4 py-6">
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <h1 class="h3 mb-0 text-white font-bold">Tambah Agenda</h1>
            </div>
        </div>
            ...
            <div class="p-6 border-b border-white/5">
                <form action="{{ route('admin.agenda.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" class="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold transition-colors" value="{{ old('title') }}" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="date_time" class="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold transition-colors" style="color-scheme: dark;" value="{{ old('date_time') }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="location" class="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold transition-colors" value="{{ old('location') }}" placeholder="Contoh: Aula Kecamatan / Zoom">
                    ...
                    <div>
                        ...
                        <input type="url" name="link" class="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-gold transition-colors" value="{{ old('link') }}" placeholder="https://...">
                    ...
                    <div>
                        ...
                        <label class="relative inline-flex items-center cursor-pointer mt-2">
                            <input type="checkbox" name="is_active" class="sr-only peer" value="1" {{ old('is_active', '1') == '1' ? 'checked' : '' }}>
